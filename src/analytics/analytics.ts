...
const eventMap: Record<EventAnalytics, EventMeta> = {
  ...
  [EventAnalytics.HeroWhatsappButton]: { category: "Contacto", type: "Whatsapp", label: "Boton Whatsapp Hero" },
  [EventAnalytics.HeroCatalogButton]: { category: "Discovery", type: "Catalog", label: "Boton Ver Catalogo Hero" },
